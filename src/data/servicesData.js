export const servicesData = [
  ...
  {
    id: 'promotional',
    slug: 'foto-video-promotional',
    title: 'Fotografie si filmari promotionale',
    shortDesc: 'Prezentări vizuale profesionale și dinamice realizate pentru a evidenția punctele forte ale afacerii tale.',
    longDesc: 'Într-o lume vizuală, imaginea afacerii tale este prima carte de vizită. Ofer servicii complete de fotografie și producție video promoțională, menite să atragă atenția și să comunice eficient mesajul brandului tău. Fie că este vorba despre prezentarea unui produs, a unei locații sau a echipei tale, rezultatul va fi un conținut de înaltă calitate, optimizat pentru platformele de social media și marketing digital.',
    image: './images/photo2.jpg',
    features: ['Videoclipuri scurte (Reels/TikTok)', 'Fotografie de produs & locație', 'Concept creativ personalizat', 'Livrare rapidă']
  },
  {
    id: 'brand',
    slug: 'fotografie-brand',
    title: 'Fotografie de brand',
    shortDesc: 'Imagini strategice care spun povestea business-ului tău și transmit profesionalism.',
  ...
  },
  {
    ...
    shortDesc: 'Un suport informativ și prietenos ce te ajută să îți organizezi ziua nunții fără stres.',
    longDesc: 'Organizarea unei nunți poate fi copleșitoare, de aceea am creat Ghidul Miresei. Acest document este rezultatul sutelor de evenimente la care am participat și conține sfaturi practice, liste de verificare și recomandări pentru ca ziua voastră să fie una fără griji. De la gestionarea luminii ambientale până la planificarea programului, acest ghid este partenerul tău de încredere în drumul către altar.',
    image: './images/Ghidul Miresei.png',
    features: ['Checklist-uri complete', 'Sfaturi pentru lumină & locație', 'Planificarea timpului', 'Contacte furnizori recomandați']
  }
];
